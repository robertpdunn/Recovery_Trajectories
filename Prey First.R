...
maxfished<-max(y$FishedDens)  #13.372    #with NCE: 11.464   #with barrens inits: 19.107
fishedvol<-(maxfished-y[400,8])/y[400,8] #0.242  with NCE: 0.334   #with barrens inits: 0.774
print(fishedvol)
PreyNCE<-y$FishedDens
maxcomm<-max(y$CommDens) #30.911
commvol<-(maxcomm - y[400,7])/y[400,7] #0.572,  with NCE: 0.765
print(commvol)
...
lines(y$Ul, type="l", lwd=2, col="darkred")
lines(y$L, type="l", lwd=2, col="indianred2")
legend(x=225,y=27,cex=0.75, c("Small Urchin","Medium Urchin","Large Urchin","Lobster"), 
       bty="n", c("purple", "blue", "darkred","indianred2"))
...
maxfished<-max(y$FishedDens)  #13.157  #in barrens: 19.18   #bi-stable: 16.489
fishedvol<-(maxfished-y[400,8])/y[400,8] #0.242  #in barrens: 0.781   #bistable: 0.531
