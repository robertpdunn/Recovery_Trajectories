...
plot(out2$time,out2$A, type="l", col="forestgreen", ylim=c(0,3000), lwd=2, ylab="Biomass (kg)", 
     xlab="Years since fishery closure", bty="L")
plot(out2$time, out2$Us, type="l", col="purple", ylim=c(0,20), lwd=2, ylab="Biomass (kg)", 
     xlab="Years since fishery closure", bty="L")
...
legend(x=155,y=17,cex=0.75, c("Small Urchin","Medium Urchin","Large Urchin","Lobster"), 
...
plot(out2$time,out2$A, type="l", col="forestgreen", ylim=c(0,3000), lwd=2, ylab="Biomass (kg)", 
     xlab="Years since fishery closure", bty="L")
plot(out2$time, out2$Us, type="l", col="purple", ylim=c(0,30), lwd=2, ylab="Biomass (kg)", 
     xlab="Years since fishery closure", bty="L")
lines(out2$time,out2$Um, type="l", col="blue", lwd=2)
lines(out2$time,out2$Ul, type="l", col="darkred", lwd=2)
lines(out2$time,out2$L, type="l", col="indianred2", lwd=2)
