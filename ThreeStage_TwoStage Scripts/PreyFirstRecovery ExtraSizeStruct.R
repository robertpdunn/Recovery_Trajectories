...
maxfished<-max(y$FishedDens) #16.193
fishedvol<-maxfished-y[400,9] # 4.179
preyExtraSize<-y$FishedDens
maxcomm<-max(y$CommDens) #28.771
commvol<-maxcomm-y[400,8] #8.567
