...
###----------parameters----------------------###
state<-c(A=2671.189, Us= 4.774686, Um= 0.4260906, Ul=0.279405, Ls=2.872615, L=10.49978)   #Unexploited equilibrium, ExtraSizeStructure
...
deltaLs= 0.3  #rate of small urchin consumption by lobsters, 0.2
deltaLm=0.1  #rate of med urchin consumption by lobsters, 0.15
deltaLl=0.005   #rate of large urchin consumption by lobsters, 0.05
deltaLss= 0.2   #rate of small urchin consumption by small lobsters, 0.1
deltaLms= 0.05   #rate of medium urchin consumption by small lobsters, 0.075
...
maxfished<-max(y$FishedDens) #13.755
fishedvol<-maxfished-y[400,9] # 1.741
predExtraSize<-y$FishedDens
maxcomm<-max(y$CommDens) #27.003
commvol<-maxcomm-y[400,8] #6.799
